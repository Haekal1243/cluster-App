...
"[project]/frontend/src/app/register/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PersonalDataPage() {
    ...
    const handleBack = async ()=>{
        const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$message$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showConfirm"])("Batalkan Registrasi?", "Data yang sudah diisi akan hilang.", "warning", "Ya, batalkan", "Lanjut isi");
        if (ok) {
            router.push("/");
        }
    };
...
//# sourceMappingURL=frontend_src_1p28qg3._.js.map