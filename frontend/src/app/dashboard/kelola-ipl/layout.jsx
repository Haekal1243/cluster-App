...
import { can, canAny, isWargaView } from "@/lib/session";
  ...
  return (
    <div className="page-stack">
      <div className="ipl-page-header">
        <div>
          <h2 className="ipl-page-title">Kelola IPL</h2>
          <p className="ipl-page-subtitle">Kelola tagihan dan setoran IPL — Tagihan untuk penagihan warga, Setoran untuk rekap RT ke RW.</p>
        </div>
      </div>
