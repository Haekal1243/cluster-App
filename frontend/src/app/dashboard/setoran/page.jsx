  ...
  return (
    <div className="page-stack">
      <div className="ipl-page-header">
        <div>
          <h2 className="ipl-page-title">Setoran IPL</h2>
          <p className="ipl-page-subtitle">
            {bolehKonfirmasi
              ? "Setoran porsi IPL dari tiap RT. Konfirmasi setelah dana diterima."
              : "Setoran porsi IPL RT ke bendahara RW. Kas RT tidak ikut disetor."}
          </p>
        </div>
      </div>
      ...
      {bolehSetor && siap && (
        <div className="ipl-summary-grid">
          <div className={`ipl-summary-card ${siap.jumlahTagihan > 0 ? "tone-info" : "tone-muted"}`}>
            <div className="ipl-summary-icon"><Landmark size={20} /></div>
          ...
          <div className="ipl-summary-card tone-success setoran-cta">
            <div className="ipl-summary-body">
              {pilihRtSetor && (
              ...
              {siap.jumlahTagihan === 0 && <span className="ipl-summary-sub">Belum ada tagihan lunas yang perlu disetor.</span>}
            </div>
          </div>
        </div>
      )}
      ...
      {summary && (
        <div className="ipl-summary-grid">
          ...
          <div className={`ipl-summary-card ${summary.menunggu > 0 ? "tone-warning" : "tone-muted"}`}>
            <div className="ipl-summary-icon"><Clock size={20} /></div>
            <div className="ipl-summary-body">
          ...
          <div className={`ipl-summary-card ${summary.ditolak > 0 ? "tone-danger" : "tone-muted"}`}>
            <div className="ipl-summary-icon"><XCircle size={20} /></div>
            <div className="ipl-summary-body">
